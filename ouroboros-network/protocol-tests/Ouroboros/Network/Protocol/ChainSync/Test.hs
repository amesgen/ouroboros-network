...
genChainSync :: forall header point tip.
                Gen point
             -> Gen header
             -> Gen tip
...
instance Arbitrary (AnyMessage ChainSync_BlockHeader) where
...
instance Arbitrary (AnyMessage ChainSync_Serialised_BlockHeader) where
